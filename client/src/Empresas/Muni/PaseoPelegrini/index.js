...
import ocho from "../PaseoPelegrini/10.jpg";
import nueve from "../PaseoPelegrini/12.jpg";
import diez from "../PaseoPelegrini/13.jpg";
const ImagesPelegrini = {
  nueve,
  diez,
  dos,
  uno,
...
export default ImagesPelegrini;
